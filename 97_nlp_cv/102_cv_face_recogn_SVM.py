#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# This code shows how to train a SVM classifier model
# based on embedding npz.
...
# load test data and reshape the image
Img = 'data/cv/WechatIMG2074.jpeg'
# Img = 'data/cv/Aamir_Khan_2.jpg'
# plt.imshow(Img)
...
#save out_encoder
with open('model/in_encoder.pickle','wb') as f:
    pickle.dump(in_encode, f)
...
#save it
with open('model/cv_clf.pickle','wb') as f:
    pickle.dump(model,f)

#save out_encoder
with open('model/out_encoder.pickle','wb') as f:
    pickle.dump(out_encode,f)
...
print("Accuracy score on training data is {}".format(acc_train))
